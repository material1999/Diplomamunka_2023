...
runtimes_path = "runtimes/phase_1_5.txt"
...
for i in range(1, 2):
    for graph_num in range(1, graphs + 1, 10):
        ...
        # átlagolás, edge dict-ben minden kulcshoz tartozó értéket oszatni az instance-ok számával

        for k, v in edge_weight_sum_dict.items():
            edge_weight_sum_dict[k] = v / instances
        ...
        for k, v in vertex_in_instance_dict.items():
            ...
            if sum > 0:
                ...
                edge_weight_sum_dict[new_edge_name] = sum
        ...
        for k, v in vertex_in_instance_dict.items():
            ...
            edge_weight_sum_dict[new_edge_name] = v
        ...
        graph_flow_path = "results/graph_flow/5/" + str(graph_num) + ".txt"
