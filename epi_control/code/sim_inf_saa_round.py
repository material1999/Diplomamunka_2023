...
runtimes_path = "runtimes/sim_inf_saa_round.txt"
...
for graph_num in range(1, graphs + 1, 10):
    ...
    vertices_to_delete_path = "results/saa_round_formatted/5/" + str(graph_num) + ".sol"
    ...
    with open(edges_path, "r") as edges_input, open(vertices_path, "r") as vertices_input:
        ...
        sim_inf_path = "results/sim_inf_saa_round/5/" + str(graph_num) + ".txt"
